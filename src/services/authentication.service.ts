...
export class AuthenticationService {
  private loginbaseUrl = 'https://emislogin.tnschools.gov.in/emis_login/api/login';
...
debugger;
        if (user && user.dataStatus) {
          ...
          this.sessionData.educationMediumId = decodedToken['education_medium_id'];
          ...
          this.sessionData.section = decodedToken['class_section'];
